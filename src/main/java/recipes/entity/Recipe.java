...
public class Recipe {
	...
	public String toString() {
		DateTimeFormatter fmTimeFormatter = DateTimeFormatter.ofPattern("dd-MMM-yyyy HH:mm");
		String createTime = Objects.nonNull(createdAt) ? fmTimeFormatter.format(createdAt) : "(null)";
